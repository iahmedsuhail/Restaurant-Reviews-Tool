...
class ReviewComponent extends React.Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    if (googleID !== undefined) {
      fetch(
        `${"https://cors-anywhere.herokuapp.com/"}https://maps.googleapis.com/maps/api/place/details/json?key=${GOOGLE_PLACES_API_KEY}&place_id=${googleID}&type=restaurant&fields=photo,review,formatted_address,formatted_phone_number,name,rating,price_level,website`,
        {
          mode: "cors",
        }
      )
          ...
          this.setState(
            ...
            function () {
              if (this.state.gpPhotoReference !== "") {
                //Get Image jpg
                fetch(
                  `${"https://cors-anywhere.herokuapp.com/"}https://maps.googleapis.com/maps/api/place/photo?maxwidth=1000&photoreference=${
      ...
      axios
        .get(
          `${"https://cors-anywhere.herokuapp.com/"}https://api.yelp.com/v3/businesses/${yelpID}`,
          {
            headers: {
      ...
      axios
        .get(
          `${"https://cors-anywhere.herokuapp.com/"}https://api.yelp.com/v3/businesses/${yelpID}/reviews`,
          {
            headers: {
              Authorization: `Bearer ${YELP_PLACES_API_KEY}`,
              "X-Requested-With": "XMLHttpRequest",
      ...
      fetch(
        `${"https://cors-anywhere.herokuapp.com/"}https://developers.zomato.com/api/v2.1/restaurant?res_id=${zomatoID}`,
        {
          mode: "cors",
          headers: {
      ...
      fetch(
        `${"https://cors-anywhere.herokuapp.com/"}https://developers.zomato.com/api/v2.1/reviews?res_id=${zomatoID}`,
        {
          mode: "cors",
          headers: {
            Accept: "application/json",
  ...
  return (
    <div>
      <Grid container direction="column" justify="center" alignItems="center">
        <button
          className="grow f4 ph3 pv2 dib white bg-light-purple"
          onClick={() => onAddToCompareClick("yelp", yelpCompareID)}
        >
          Add to Compare
        </button>
  ...
  return (
    <div>
      <Grid container direction="column" justify="center" alignItems="center">
        <button
          className="grow f4 ph3 pv2 dib white bg-light-purple"
          onClick={() => onAddToCompareClick("google reviews", googleCompareID)}
        >
          Add to Compare
        </button>
        <div className="tc review-component  br3 pa3 ma2 dib bw2 shadow-5 sunflower-light mw-75 w-75">
  ...
  return (
    <div>
      <Grid container direction="column" justify="center" alignItems="center">
        <button
          className="grow f4 ph3 pv2 dib white bg-light-purple"
          onClick={() => onAddToCompareClick("zomato", zomatoCompareID)}
        >
          Add to Compare
        </button>
        <div className="tc review-component  br3 pa3 ma2 dib bw2 shadow-5 sunflower-light mw-75 w-75">
